...
class SearchMogus extends StatefulWidget {
  SearchMogus({Key? key}) : super(key: key);
  ...
  @override
  State<SearchMogus> createState() => _SearchMogusState();
}

class _SearchMogusState extends State<SearchMogus> {
  late var rest;
...
/*
  ...
  */
  ...
  void searchResturants(double lat, double long, String categorie) async {
    ...
    Restaurant rest = Restaurant.fromJson(jsonDecode(response.data));
    // print("Mogus ${rest.cats}");
  ...
  getStuff() {
    ...
    return _restaurants.map((restaurant) {
      ...
      list.add(Restaurant(
          alias: restaurant["name"], distance: restaurant["distance"]));
      return Padding(
          ...
          child: Container(
            ...
            child: ListTile(
                onTap: () {
                  ...
                  try {
                    setState(() {
                      cat1 = restaurant["categories"][0]["title"];
                      cat2 = restaurant["categories"][1]["title"];
                      cat3 = restaurant["categories"][2]["title"];
                    });
                  } catch (_) {
                    print("NO CATEGORIE MOGUS");
                  }
                ...
                leading: ClipRRect(
                  child: CircleAvatar(
                    backgroundImage: (restaurant["image_url"]! == null)
                        ? const NetworkImage(
